...
This ADR remains the source of truth for the **free profile gate UX**, but its historical
scope statement that CareerAsana is not integrated is superseded by
`docs/integration-career-diya-careerasana.md`.

CareerAsana now shares the canonical Supabase identity with Career Diya. The free exploration
still remains free and is not routed through CareerAsana's paid/deeper execution engine.
